...
class AppLocalizations {
  ...
  static const _values = <String, Map<String, String>>{
    'fr': {'appName': 'Wifi Mouni', 'login': 'Connexion', 'register': 'Créer un compte', 'email': 'Adresse e-mail', 'password': 'Mot de passe', 'emailRequired': 'Saisissez votre adresse e-mail.', 'emailInvalid': 'Saisissez une adresse e-mail valide.', 'passwordRequired': 'Saisissez votre mot de passe.', 'passwordTooShort': 'Le mot de passe doit contenir au moins 6 caractères.', 'continue': 'Continuer', 'settings': 'Paramètres', 'language': 'Langue', 'chooseLanguage': 'Choisir la langue', 'welcome': 'Bienvenue sur Wifi Mouni', 'home': 'Accueil', 'logout': 'Déconnexion', 'noAccount': 'Pas encore de compte ?', 'hasAccount': 'Vous avez déjà un compte ?', 'createAccount': 'Inscrivez-vous pour commencer', 'loginSubtitle': 'Connectez-vous à votre compte'},
